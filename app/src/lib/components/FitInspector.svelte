<script lang="ts">
  // Fit mode's Inspector: everything about producing a device copy - the
  // profile, where it goes, what it is called, and the conversion knobs.
  // Fitting always writes a copy; there is no in-place option here, by design.
